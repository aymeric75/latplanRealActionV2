...
exec 1>mymnist_755REALOneHotX0Y0by10-makeplans.out 2>mymnist_755REALOneHotX0Y0by10-makeplans.err
...
conf_folder="05-06T11:21:55.052REALOneHot"
domains_dirs=samples/$after_sample/logs
...
# for dir in $domains_dirs/*/
# do
#     if [[ "$(basename $dir)" == "05-06T14:43:56.755REALOneHotX0Y0by10" ]]; then
#         current_dir=$(basename $dir)
#         echo $current_dir
...
#     if [[ "$base_dir" == "05-06T11:21:55.052REALOneHot" ]]
#     then
#         for pb in $dir$probs_subdir/*/
#         do
#             # echo "pwdd"
...
#         for pb in $dir$probs_subdir/*/
#         do
#             thepb=$(find /workspace/latplanRealActionsV2/$pb -type f -name "*problem.pddl")
#             echo "33"
#             echo $thepb
...
do
    echo "nouveau"
    if [[ "$(basename $dir)" == "05-06T11:21:55.052REALOneHot" ]]; then
        echo ${dir}domain.pddl
        echo $probs_subdir
